...
VALUES ('TTT Workshop', 'This is the intial Train The Trainers workshop that kicks off the 24-month cycle', 0, null, null),
	   ...
	   ('Observed Training', 'Local trainers to need conduct a training that is observed by one of the national trainers', 335, 60, 30),
	   ('Certification', 'This is the official certification date', 730, 60, 30);
